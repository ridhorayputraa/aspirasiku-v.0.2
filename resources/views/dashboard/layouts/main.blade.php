...
<head>
    ...
    <title>Aspirasiku || Dashboard</title>

    <link rel="stylesheet" href="/assets/css/main/app.css">
    <link rel="stylesheet" href="/assets/css/main/app-dark.css">

    <link rel="shortcut icon" class="rounded-circle" href="/img/aspirasiku.ico">
...
<div class="page-heading">
    <h3>Dashboard || <a class="text-decoration-none link-light" href="/">Aspirasiku</a></h3>
</div>
